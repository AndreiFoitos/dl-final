...
class LSTM_Model(nn.Module):
    """
    LSTM model - mitigates vanishing gradients through gating mechanisms
    """
    def __init__(self, input_size=1, hidden_size=256, num_layers=20, dropout=0, num_classes=10, init_method='xavier'):
...
class GRU_Model(nn.Module):
    """
    GRU model - simpler than LSTM but also mitigates vanishing gradients
    """
    def __init__(self, input_size=1, hidden_size=256, num_layers=20, dropout=0, num_classes=10, init_method='xavier'):
